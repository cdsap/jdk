...
#define GC_G1_FLAGS(develop,                                                \
  ...
  product(uint, G1ConfidencePercent, 50,                                    \
          ...
          range(0, 100)                                                     \
                                                                            \
  product(uint, ImNotOkayPauseHeadroomPercent, 15, EXPERIMENTAL,            \
          ...
          range(0, 50)                                                      \
                                                                            \
  product(uint, ImNotOkayPauseHeadroomTriggerPercent, 60, EXPERIMENTAL,     \
          ...
          range(1, 100)                                                     \
                                                                            \
  product(uint, ImNotOkayBurstEdenClampPercent, 20, EXPERIMENTAL,           \
          ...
          range(0, 50)                                                      \
                                                                            \
  product(uint, ImNotOkayBurstEdenClampTriggerPercent, 35, EXPERIMENTAL,    \
