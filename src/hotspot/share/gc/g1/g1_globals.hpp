...
#define GC_G1_FLAGS(develop,                                                \
  ...
  product(uint, G1ConfidencePercent, 50,                                    \
          ...
          range(0, 100)                                                     \
                                                                            \
  product(uint, ImNotOkayPauseHeadroomPercent, 1, EXPERIMENTAL,             \
  ...
  product(uint, ImNotOkayBurstSustainedPressurePercent, 80, EXPERIMENTAL,   \
          ...
          range(1, 100)                                                     \
                                                                            \
  product(uint, ImNotOkayThroughputBackoffTriggerPercent, 30, EXPERIMENTAL, \
          "When predicted non-eden pause work already exceeds this "        \
  ...
  product(uint, ImNotOkayGcToAppTimeTriggerPercent, 12, EXPERIMENTAL,      \
          ...
          range(1, 100)                                                     \
                                                                            \
  product(uint, ImNotOkayMaxYoungPercent, 92, EXPERIMENTAL,                \
